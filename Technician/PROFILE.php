...
?>
	<form action="" method="POST">
		...
		<div class="text-center">
        		<img src="<?php if(isset($row[ 'profile_pi'])) {echo "../Admin/".$row['profile_pi']; }?>" width="150px" height="150px" style="border-radius: 50%" class="avatar img-circle img-thumbnail" alt="avatar">
      	</div></hr><br>
