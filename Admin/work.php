...
<div class="col-sm-9 col-md-10 mt-5">
 ...
 if($result->num_rows > 0){
  ...
  while($row = $result->fetch_assoc()){
    ...
    <td><form action="viewassignwork.php" method="POST" class="d-inline"> <input type="hidden" name="id" value='. $row["request_id"] .'><button type="submit" class="btn btn-warning" name="view" value="View"><i class="fa fa-eye" aria-hidden="true"></i></button></form>
