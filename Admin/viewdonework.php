...
<div class="col-sm-6 mt-5  mx-3">
 <h3 class="text-center">Done Work Details</h3>
 <?php
 if(isset($_REQUEST['view'])){
  $sql = "SELECT * FROM workdone_tb WHERE request_id = {$_REQUEST['id']}";
 ...
 <table class="table table-bordered">
  <tbody>
   ...
   <tr>
    <td>Assigned Date</td>
    <td>
     <?php if(isset($row['work_date'])) {echo $row['work_date']; }?>
    </td>
   </tr>
   <tr>
    ...
    <td>Amount</td>
    <td>
     <?php if(isset($row['amount'])) {echo $row['amount']." RS"; }?>
    </td>
   </tr>
  </tbody>
 </table>
