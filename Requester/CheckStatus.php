...
<div class="col-sm-6 mt-5  mx-3 mowi">
  ...
  if(isset($_REQUEST['checkid'])){
    ...
    if(($row['request_id'] == $_REQUEST['checkid']) && ($row['uEmail'] == $uEmail))
      { ?>
  ...
  <?php } 
  elseif (($row1['request_id'] == $_REQUEST['checkid']) && ($row1['uEmail'] == $uEmail)) {
  ...
  elseif (($row['request_id'] == $_REQUEST['checkid']) && ($row['uEmail'] == $uEmail) &&($row1['request_id'] == $_REQUEST['checkid']) && ($row1['uEmail'] == $uEmail)) {
    
    echo '<div class="alert alert-dark mt-4" role="alert">
      Your Request id is Invalid </div>';
  }
  else {
      echo '<div class="alert alert-dark mt-4" role="alert">
