...
<div class="col-sm-5 mt-5 jumbotron col-md-9">
	...
	<form action="" method="POST">
		...
		<div class="text-center">
        		<img src="<?php if(isset($row[ 'profile_pi'])) {echo "../Admin/".$row['profile_pi']; }?>" width="150px" height="150px" style="border-radius: 50%" class="avatar img-circle img-thumbnail" alt="Profile pic">
    </div></hr><br>
